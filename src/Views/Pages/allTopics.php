...
<head>
    ...
    <title>All Topics - Liquid Glass Forum</title>
    <link rel="stylesheet" href="../assets/css/css.php?file=styles.css">
</head>
<body>
    ...
    <main class="main-content">
        <div class="container">
            <div class="page-header">
                <h1>All Topics</h1>
                <p>Browse all discussions across the forum</p>
            </div>
            ...
            <div class="topics-controls liquid-glass">
                <div class="search-section">
                    <div class="search-container">
                        ...
                        <input type="text" placeholder="Search topics..." class="search-input" id="searchInput">
                    </div>
                </div>
    ...
    <script src="../assets/js/javascript.php?file=allTopics.js"></script>
</body>
</html>
